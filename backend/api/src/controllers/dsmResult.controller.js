...
import ValidationReport from "../models/ValidationReport.model.js"; // Ensure exact case
import DsmResult from "../models/DsmResults.model.js";             // Ensure exact case
...
export const validateDSM = asyncHandler(async (req, res) => {
    ...
    // Upsert: Create a new report OR overwrite the existing one if it already exists
